...
const conceptos = () => {
  return (
    <div class="p-4 pb-0 xl:flex justify-center items-center sm:ml-72 max-h-max xl:mr-10 overflow-y-auto my-20">
      ...
      <div class="xl:w-3/4">
        <Titles>Optimización de Energia</Titles>
        {/* </div> */}
        <div class="h-[75vh]">
        <iframe loading="lazy" class=" h-full w-full" src="https://www.canva.com/design/DAGM85nVx9o/CnJA8ohoKdgO9AIvIZGVKw/view?embed" 
