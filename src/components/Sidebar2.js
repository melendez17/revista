          ...
          <ul class="space-y-2 font-medium">
            {SidebarData.map((item, index) => (
              <li key={index}>
                <button
                  type="button"
                  className="flex px-4 items-center w-full p-2 justify-between text-sm text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                    ...
                    {item.subNav &&
                      item.subNav.map((subItem, subIndex) => (
                        <li key={subIndex}>
                          <Link
                            to={subItem.path}
                            className="flex text-sm items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                          >
